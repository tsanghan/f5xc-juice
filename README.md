...
4. Please also edit `terraform.tfvars.tmpl` file to you needs, `update_ips.sh` will pull down the latest F5XC Network Cloud Reference RE IP addresses list, and create `terraform.tfvars` file from template and add `ip_address_list` variable with RE IP addresses list.
